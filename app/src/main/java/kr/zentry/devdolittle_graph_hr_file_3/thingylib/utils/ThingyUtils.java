package kr.zentry.devdolittle_graph_hr_file_3.thingylib.utils;
...
//    public static final UUID NFC_CHARACTERISTIC_UUID                                            = new UUID(0xEF6801099B354933L, 0x9B1052FFA9740042L);
    ...
    public static final UUID SCHEDULE_SERVICE = new UUID(0xEF6807009B354933L, 0x9B1052FFA9740042L);


    public static final UUID SCHEDULE_NOW_TIME_CHARACTERISTIC = new UUID(0xEF6807019B354933L, 0x9B1052FFA9740042L);
    public static final UUID SCHEDULE_MEASUREMENT_REGISTER_CHARACTERISTIC = new UUID(0xEF6807029B354933L, 0x9B1052FFA9740042L);
    public static final UUID SCHEDULE_MEASUREMENT_ENABLE_CHARACTERISTIC = new UUID(0xEF6807039B354933L, 0x9B1052FFA9740042L);
    public static final UUID SCHEDULE_MEASUREMENT_RR_INFO_CHARACTERISTIC = new UUID(0xEF6807049B354933L, 0x9B1052FFA9740042L);
    public static final UUID SCHEDULE_MEASUREMENT_HR_INFO_CHARACTERISTIC = new UUID(0xEF6807059B354933L, 0x9B1052FFA9740042L);
    ...
    //심박 그래프 테스트 용 로우데이터 전달
    public static final UUID SCHEDULE_MEASUREMENT_HEART_GRAPH_ROWDATA_TEST = new UUID(0xEF6807099B354933L, 0x9B1052FFA9740042L);
    //호흡 그래프 테스트 용 로우데이터 전달
    public static final UUID SCHEDULE_MEASUREMENT_RR_GRAPH_ROWDATA_TEST = new UUID(0xEF6807109B354933L, 0x9B1052FFA9740042L);
...
//    public static final UUID GRAVITY_VECTOR_CHARACTERISTIC                                      = new UUID(0xEF68040A9B354933L, 0x9B1052FFA9740042L);
    ...
    public static final String HrROWDATAGRAPH_NOTIFICATION = "HEARTROWDATAGRAPH_NOTIFICATION_";
    public static final String RrROWDATAGRAPH_NOTIFICATION = "RRROWDATAGRAPH_NOTIFICATION";
    ...
    public static final String REALTIME_RR_NOTIFICATION = "REALTIME_RR_NOTIFICATION_";
    public static final String REALTIME_HR_NOTIFICATION = "REALTIME_HR_NOTIFICATION_";
    ...
    /* 심박 수 로우데이터 그래프 테스트 용*/
    public static final String EXTRA_DATA_CURRNET = "EXTRA_DATA_CURRNETDATA";
    public static final String EXTRA_DATA_AVER = "EXTRA_DATA_AVER";
    public static final String EXTRA_DATA_THRESHOLD = "EXTRA_DATA_THRESHOLD";
    public static final String EXTRA_DATA_COUNTCANDIDATE = "EXTRA_DATA_COUNTCANDIDATE";
    public static final String EXTRA_DATA_COUNTFINAL = "EXTRA_DATA_COUNTFINAL";
