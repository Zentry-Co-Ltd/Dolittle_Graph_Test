...
class CustomCalendarAdapter(context: Context, cal: Calendar) {
    ...
    fun refresh() {
        ...
        for (i in offset until length + offset) {
            ...
            val view = mInflater.inflate(R.layout.item_custom_calendar, null)
            val txtDay = view.findViewById<View>(R.id.txt_day) as TextView
            val imgEventTag = view.findViewById<View>(R.id.img_item_custom_cal_event) as ImageView
