...
open class CustomCollapsibleCalendar : UICalendar, View.OnClickListener {
    override fun changeToToday() {
        val calendar = Calendar.getInstance()
        val calenderAdapter = CustomCalendarAdapter(context, calendar);
    ...
    private var mAdapter: CustomCalendarAdapter? = null
    ...
    protected fun init(context: Context) {
        ...
        val cal = Calendar.getInstance()
        val adapter = CustomCalendarAdapter(context, cal)
        setAdapter(adapter)
    ...
    // public methods
    fun setAdapter(adapter: CustomCalendarAdapter) {
        mAdapter = adapter
    ...
    fun setStateWithUpdateUI(state: Int) {
        this@CustomCollapsibleCalendar.state = state
